                ...
                <div className="flex flex-col justify-center space-y-4 text-center">
                  <div className="space-y-2">
                    ...
                    <p className="max-w-[600px] text-muted-foreground md:text-xl mx-auto">
                      Manage your workforce, track leave, conduct performance
                      reviews, and store important documents all in one place.
                    </p>
                  </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Maintain comprehensive employee profiles with all relevant
                    information.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Track and approve leave requests with an intuitive calendar
                    interface.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Conduct regular performance evaluations and track employee
                    growth.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Store and organize important HR documents securely in one
                    place.
                  </p>
                </CardContent>
              </Card>
